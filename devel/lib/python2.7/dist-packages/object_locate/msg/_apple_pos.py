...
"""autogenerated by genpy from object_locate/apple_pos.msg. Do not edit."""
import sys
...
class apple_pos(genpy.Message):
  _md5sum = "cb605b25d565ff4ea61c702d2fc0b3a2"
  _type = "object_locate/apple_pos"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """std_msgs/Char[] data
...
"""
  __slots__ = ['data','pose']
  _slot_types = ['std_msgs/Char[]','geometry_msgs/Pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(apple_pos, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.data:
        buff.write(_get_struct_B().pack(val1.data))
      _x = self
